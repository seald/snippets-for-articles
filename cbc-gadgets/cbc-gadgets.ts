...
/**
 * Function to inject gadget0 and g1 instead of the first block.
 ...
 * @param g0 The plaintext value of the first block to inject which will replace p0
 * @param g1 The plaintext value of the second block to inject which will be placed before the second block of the message
 */
export const injectGadget = (encryptedData: Buffer, p0: Buffer, g0: Buffer, g1: Buffer): Buffer => {
    ...
    return Buffer.concat([
        x0, // forged IV
        c0, // forged 1st block which will be decrypted into g0
        x1, // forged block with garbage, allows to link with next block
        c0, // forged 3rd block which will be decrypted into g1
